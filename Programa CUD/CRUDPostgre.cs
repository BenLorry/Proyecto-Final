...
{
    public partial class CRUDPostgre : Form
    {
        public CRUDPostgre()
        {
            InitializeComponent();
        ...
        string consulta = "";
        private void CRUDPostgre_Load(object sender, EventArgs e)
        {
        ...
        private void btnEjecutarConsulta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NpgsqlConnection conexion = new NpgsqlConnection(Datos.cadenaConexion2);
                conexion.Open();
                ...
                Datos.AgrearDataTable2(ds, consulta, cbTabla.Text); //ANTIGUO
